...
> Deep learning image classifier distinguishing between cats and dogs using transfer learning with ResNet18. Achieves 95%+ validation accuracy.
...
### Try it in Colab
Click the badge above to open in Google Colab - no setup required!
